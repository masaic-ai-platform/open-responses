...
class EvalServiceTest {
    ...
    fun setup() {
        ...
        every { SampleSchemaUtils.sampleSchemaForEvals() } returns mapOf(
            "type" to "object",
            "properties" to mapOf(
    ...
    @Test
    fun `createEval should create eval with custom data source config`() = runTest {
        // Given
        ...
        val createRequest = CreateEvalRequest(
            name = "Test Eval",
            dataSourceConfig = CustomDataSourceConfigRequest(
                schema = mapOf(
                    "properties" to mapOf(
        ...
        coVerify {
            evalRepository.createEval(match {
                it.name == "Test Eval" &&
    ...
    @Test
    fun `createEval should create eval with stored completions data source config`() = runTest {
        // Given
        val testingCriterion = LabelModelGrader(
    ...
    @Test
    fun `createEval should create eval with text similarity grader`() = runTest {
        // Given
        val testingCriterion = TextSimilarityGrader(
    ...
    @Test
    fun `getEval should return eval by ID`() = runTest {
        // Given
    ...
    @Test
    fun `getEval should return null when eval does not exist`() = runTest {
        // Given
    ...
    @Test
    fun `listEvals should return all evals`() = runTest {
        // Given
    ...
    @Test
    fun `listEvals with params should return paginated results`() = runTest {
        // Given
    ...
    @Test
    fun `listEvals with params should handle empty results`() = runTest {
        // Given
        val params = ListEvalsParams(
            limit = 10,
            order = "desc"
    ...
    @Test
    fun `deleteEval should return true when eval exists`() = runTest {
        // Given
        val evalId = "eval_123"
    ...
    @Test
    fun `deleteEval should return false when eval does not exist`() = runTest {
        // Given
        val evalId = "non_existent_eval"
    ...
    @Test
    fun `updateEval should update an eval`() = runTest {
        // Given
        val evalId = "eval_123"
        ...
        coVerify { evalRepository.getEval(evalId) }
        coVerify { 
            evalRepository.updateEval(match { 
                it.id == evalId && 
    ...
    @Test
    fun `updateEval should return null when eval does not exist`() = runTest {
        // Given
        val evalId = "non_existent_eval"
        val updateRequest = UpdateEvalRequest(
            name = "Updated Name"
    ...
    @Test
    fun `updateEval should only update provided fields`() = runTest {
        // Given
        val evalId = "eval_123"
        val existingEval = createSampleEval(evalId)
        val updateRequest = UpdateEvalRequest(
    ...
    private fun createSampleEval(
        ...
        val dataSourceConfig = CustomDataSourceConfig(
            schema = mapOf(

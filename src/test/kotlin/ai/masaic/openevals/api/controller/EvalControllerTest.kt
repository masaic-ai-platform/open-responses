...
class EvalControllerTest {
    ...
    @Test
    fun `createEval should return created evaluation with status 201`() = runBlocking {
        // Arrange
        val request = CreateEvalRequest(
            name = "Test Eval",
    ...
    @Test
    fun `getEval should return evaluation when found`() = runBlocking {
        // Arrange
        val evalId = "eval-123"
        val expectedEval = Eval(
            id = evalId,
    ...
    @Test
    fun `getEval should throw ResponseStatusException when not found`() = runBlocking {
        // Arrange
    ...
    @Test
    fun `listEvals should return paginated list of evaluations`() = runBlocking {
        // Arrange
        ...
        val expectedResponse = EvalListResponse(
            data = evalList,
            hasMore = false,
            firstId = "eval-1",
            lastId = "eval-2",
        ...
        // Act
        val response = evalController.listEvals(
            limit = params.limit,
            order = params.order,
            after = params.after,
    ...
    @Test
    fun `listEvals should throw exception for invalid limit`() = runBlocking {
        // Act & Assert
        val exception = assertThrows<ResponseStatusException> {
    ...
    @Test
    fun `listEvals should throw exception for invalid order`() = runBlocking {
        // Act & Assert
        val exception = assertThrows<ResponseStatusException> {
    ...
    @Test
    fun `deleteEval should return no content when successful`() = runBlocking {
        // Arrange
        val evalId = "eval-123"
    ...
    @Test
    fun `deleteEval should throw ResponseStatusException when not found`() = runBlocking {
        // Arrange
        val evalId = "non-existent-id"
    ...
    @Test
    fun `updateEval should return updated evaluation when successful`() = runBlocking {
        // Arrange
        val evalId = "eval-123"
        val request = UpdateEvalRequest(
            name = "Updated Eval",
    ...
    @Test
    fun `updateEval should throw ResponseStatusException when not found`() = runBlocking {
        // Arrange
        val evalId = "non-existent-id"
